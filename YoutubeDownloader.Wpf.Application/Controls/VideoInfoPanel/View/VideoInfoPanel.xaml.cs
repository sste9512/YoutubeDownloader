...
namespace YoutubeDownloader.Wpf.Application.Controls.VideoInfoPanel.View
{

    public class InfoPanelViewModel
    {
        private Video Video { get; set; }
        private MediaStreamInfo MediaStreamInfo { get; set; }
    }
    ...
    public partial class VideoInfoPanel : UserControl
    {
        ...
        public async void SyncInfo(InfoPanelViewModel infoPanelViewModel)
        {
